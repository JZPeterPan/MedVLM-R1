...
class Qwen2VLGRPOTrainer(Trainer):
    ...
    def __init__(
        ...
        if isinstance(model, str):
            ...
            if "Qwen2-VL" in model_id or 'Huatuo' in model_id:
        ...
        if processing_class is None:
            if "Qwen2-VL" in model_id or "Qwen2.5-VL" in model_id or "Aria" in model_id or 'Huatuo' in model_id:
    ...
    def compute_loss(self, model, inputs, return_outputs=False, num_items_in_batch=None):
        ...
        image_ids = [x["image_id"] for x in inputs]
        ...
        with unwrap_model_for_generation(model, self.accelerator) as unwrapped_model:
            ...
            all_completions = []
            # replicate num_generations times
            image_ids = [x for x in image_ids for _ in range(self.num_generations)]
            problems = [x for x in problems for _ in range(self.num_generations)]
        ...
        for i, (reward_func, reward_processing_class) in enumerate(
            ...
            if isinstance(reward_func, PreTrainedModel):
                ...
                output_reward_func = reward_func(prompts=prompts, completions=completions, image_ids=image_ids, problems=problems, **reward_kwargs)
